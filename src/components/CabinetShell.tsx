...
function AbleglyGlyph(): JSX.Element {
  return (
    <svg width="18" height="22" viewBox="0 0 28 41" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-primary">
      ...
      <path d="M9.61833 31.904C12.5118 31.904 14.8574 29.5585 14.8574 26.665C14.8574 23.7715 12.5118 21.4259 9.61833 21.4259C6.7249 21.4259 4.37926 23.7716 4.37926 26.665C4.37926 29.5583 6.72487 31.904 9.61833 31.904Z" />
    </svg>
  );
}
